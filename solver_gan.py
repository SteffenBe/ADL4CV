...
class SolverGAN(object):
    ...
    def __init__(self, latent_dim, optim=torch.optim.Adam, optim_args_generator={}, optim_args_discriminator={},
        ...
        self.z_to_save = torch.randn(25, self.latent_dim)
    ...
    def train(self, generator, discriminator, dataloader, num_epochs=10, discriminator_step_ratio=10, log_nth=0, save_nth_batch=0):
        """
        ...
        self.z_to_save = self.z_to_save.to(device)
        ...
        for epoch in range(num_epochs):
            ...
            for i, batch in enumerate(dataloader):
                ...
                if batch_index % discriminator_step_ratio == 0:
                    # -----------------
                    #  Train Generator
                    # -----------------
                    ...
                    g_loss = self.loss_func(discriminator(gen_imgs), valid)
                ...
                dout_real = discriminator(real_imgs)
    ...
    def _save_samples(self, generator, n_iterations):
        gen_imgs = generator(self.z_to_save).detach().cpu()
